...
public static String a = "Programa test{ publica estatica vacia Principal(){cadena s1 = \"hola\", s2 = \"hola\";Si( s1 == s2 ){Escribir(s2);} } }";
        public static void main( String[] args )throws ParseException, Exception
        {
                ...
                //comp analizador;// = new comp( System.in );
                        //System.in.close();
                        //args[0]="Programa test{publica estatica vacia Principal() {cadena s1 = \"hola\";}}";
                        //String a = "Programa test{publica estatica vacia Principal() {cadena s1 = \"hola\";}}";
                        
                        //Programa test{ publica estatica vacia Principal(){cadena s1 = "hola", s2 = "hola";Si( s1 == s2 ){Escribir(s2);} } }
                        if(args.length!=0){
                          a = args[0]; 
    ...
    try {
      ...
      System.out.println("Java Parser Version 1.0.2:  Encountered errors during parse.");
        ...
        public void t(String a){
          //codigoIntermedio.traducir(args[0]);
        }
  ...
  static final public void Programa() throws ParseException {
    ...
    System.out.println("\ncodigo traducido");
    //for (int i = 0; i < jj_2_rtns.length; i++)a+= jj_2_rtns[i].first.image;
    System.out.println(codigoIntermedio.traducir(a));
