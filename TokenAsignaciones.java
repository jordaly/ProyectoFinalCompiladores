...
class TokenAsignaciones
{
	...
	public static void InsertarSimbolo(Token identificador, int tipo)
	{
		...
		System.out.println(identificador.image+" | "+identificarTipo(tipo));
	 }
	public static void imprimirTabla(){
		System.out.println(tabla.toString());
		/*System.out.println(intComp.toString());
		System.out.println(decComp.toString());
		System.out.println(strComp.toString());
		System.out.println(chrComp.toString());*/

	}
	public static String identificarTipo(int numero){
		String tipo = ""+numero;
		switch (numero) {
			case 44:
				tipo = "int";
